...
const Categories = () => (
  ...
  <h2 className="animate-fade-slide-up text-center text-3xl md:text-4xl font-bold bg-gradient-to-b from-white to-purple-200/70 bg-clip-text text-transparent mb-4">Built For Multi‑Talented Creators</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5">
        {categories.map((c,i)=>(
          <Tilt key={c.label} max={18}>
            <div style={{animationDelay:`${i*40}ms`}} className="animate-fade-slide-up group relative overflow-hidden rounded-xl bg-gradient-to-br from-[#241042]/80 to-[#31155a]/80 backdrop-blur-xl p-5 shadow-lg shadow-black/40 border border-fuchsia-500/10 hover:border-fuchsia-400/40 hover:shadow-fuchsia-600/30 transition three-d-card">
