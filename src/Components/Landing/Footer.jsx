  ...
  <footer className="px-6 py-16 bg-[#07010f]/95 text-purple-200/70 text-sm relative backdrop-blur-xl border-t border-fuchsia-500/10">
    ...
    <div className="max-w-6xl mx-auto grid md:grid-cols-5 gap-12">
      <div className="md:col-span-2">
        <h3 className="font-semibold text-lg mb-3 bg-gradient-to-r from-white to-purple-200/70 bg-clip-text text-transparent">
          TopLike
        </h3>
        <p className="text-purple-200/70 text-xs leading-relaxed max-w-sm">
          A focused weekly arena for creators to test, learn & earn through
      ...
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li>
            <a className="hover:text-white/90 transition-colors" href="#faq">
              FAQ
            </a>
          </li>
        </ul>
