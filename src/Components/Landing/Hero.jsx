...
const statCard = (value, label) => (
  <div className="bg-white/5 border border-white/10 rounded-xl p-4 backdrop-blur-sm text-center">
    ...
    <p className="text-[11px] uppercase tracking-wide text-purple-200">
      {label}
    </p>
  </div>
);
...
const Hero = ({ stats, timeLeft, onScrollHow }) => {
  ...
  return (
    <section
      id="hero"
      className="relative pt-32 md:pt-40 overflow-hidden hero-3d"
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          ...
          data-depth="0.15"
          className="parallax-layer absolute -top-32 -left-24 w-[520px] h-[520px] rounded-full bg-gradient-to-br from-fuchsia-600/25 to-purple-500/10 blur-3xl"
        />
        <div
          ref={(el) => (layersRef.current[1] = el)}
          data-depth="0.3"
          className="parallax-layer absolute top-1/3 -right-40 w-[640px] h-[640px] rounded-full bg-gradient-to-tr from-purple-400/20 to-transparent blur-2xl"
        />
        <div
          ref={(el) => (layersRef.current[2] = el)}
          data-depth="0.6"
          className="parallax-layer absolute -bottom-40 -left-20 w-[480px] h-[480px] rounded-full bg-gradient-to-tr from-pink-500/25 to-purple-600/0 blur-2xl"
        />
      ...
      >
        <div className="md:w-1/2 animate-fade-slide-left">
          ...
          <p className="mt-6 text-base md:text-lg text-purple-100 leading-relaxed max-w-xl">
            TopLike is the arena for emerging African creators – post{" "}
            <strong>one powerful photo or video each week</strong>, rally
            authentic likes, climb the chart and unlock cash rewards.
          </p>
          ...
          <div
            className="mt-8 text-purple-200 text-sm flex flex-col gap-2"
            aria-live="polite"
          >
            <div className="flex items-center gap-2">
              <FiClock /> Next cycle ends in {timeLeft.days}d {timeLeft.hours}h{" "}
              {timeLeft.minutes}m {timeLeft.seconds}s
            </div>
            <div className="flex items-center gap-2">
              <FiDollarSign /> Cash rewards paid to your TopLike wallet.
            </div>
          </div>
        </div>
        <div className="md:w-1/2 relative animate-fade-slide-right">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl flex items-center justify-center ring-1 ring-white/10 backdrop-blur-xl bg-white/5 border border-white/10 h-[380px] md:h-[480px]">
            ...
            <div className="text-center px-10">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500 to-fuchsia-600 shadow-lg shadow-purple-900/40 mb-8 hero-rotate-slow">
                <FiHeart className="text-white" size={38} />
              </div>
              <h3 className="text-white font-semibold text-2xl mb-4 tracking-tight">
                One Post. One Shot. Every Week.
              </h3>
              <p className="text-purple-100 text-sm leading-relaxed max-w-sm mx-auto">
                Focus on quality over spam. Craft your best submission – photo,
                video, reel, design or highlight clip – and let the people
                decide.
              </p>
            </div>
