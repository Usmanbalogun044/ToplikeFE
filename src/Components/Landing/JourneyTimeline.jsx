...
const JourneyTimeline = () => (
  ...
  <h2 className="animate-fade-slide-up text-3xl md:text-4xl font-bold text-center mb-5 bg-gradient-to-b from-white to-purple-200/70 bg-clip-text text-transparent">The Weekly Creator Journey</h2>
