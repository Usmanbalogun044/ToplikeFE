...
const HowItWorks = () => (
  ...
  <h2 className="animate-fade-slide-up text-3xl md:text-4xl font-bold text-center mb-5 bg-gradient-to-b from-white to-purple-200/70 bg-clip-text text-transparent">How It Works</h2>
  <p className="text-center text-purple-200/80 max-w-xl mx-auto mb-14">Three clean steps. One weekly shot. Keep leveling up.</p>
      <div className="grid md:grid-cols-3 gap-8">
        {steps.map((card,i)=>(
          <div key={card.title} style={{animationDelay:`${i*60}ms`}} className="animate-fade-slide-up relative rounded-2xl p-[2px] bg-gradient-to-br from-fuchsia-500/40 via-purple-600/30 to-violet-600/30 shadow-[0_0_0_1px_rgba(255,255,255,0.06)]">
