...
// Lightweight static illustration replacement (removed Three.js + framer-motion for performance)
const CharacterCanvas = () => (
  <div className="w-full h-full flex items-center justify-center relative overflow-hidden">
    ...
    <div className="relative w-40 h-40 rounded-2xl bg-gradient-to-br from-fuchsia-600 to-purple-700 shadow-xl shadow-fuchsia-900/40 flex items-center justify-center hero-rotate-slow">
      <span className="text-white font-extrabold text-3xl tracking-wider select-none">TL</span>
    </div>
    <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 w-72 h-72 rounded-full bg-gradient-to-tr from-fuchsia-500/20 to-purple-600/10 blur-3xl" />
  </div>
);
  ...
  return (
    <section id="weekly-journey" className="relative py-28 md:py-36 px-6 md:px-12 lg:px-20">      
      ...
      <div className="grid lg:grid-cols-2 gap-14 items-center relative">
        {/* 3D Character */}
        <div className="h-[420px] md:h-[480px] rounded-3xl overflow-hidden bg-gradient-to-br from-[#1b062d]/60 via-[#240a45]/60 to-[#320f63]/60 backdrop-blur-xl border border-purple-500/20 shadow-[0_0_0_1px_rgba(255,255,255,0.05),0_4px_40px_-10px_rgba(132,42,255,0.45)] animate-fade-slide-up">
          <CharacterCanvas />
        </div>
        {/* Textual Journey */}
        <div>
          <h2 className="animate-fade-slide-up text-4xl md:text-5xl font-extrabold tracking-tight mb-6 bg-gradient-to-r from-fuchsia-400 via-purple-300 to-fuchsia-200 bg-clip-text text-transparent">Weekly Creator Journey</h2>
          <p className="animate-fade-slide-up text-lg md:text-xl text-purple-200/80 max-w-xl leading-relaxed mb-10" style={{animationDelay:'120ms'}}>
          ...
          <div className="relative pl-6 border-l border-purple-500/30 space-y-8">
            {steps.map((s,i)=> (
              <div key={s.day} style={{animationDelay:`${i*55}ms`}} className="group animate-fade-slide-up">
